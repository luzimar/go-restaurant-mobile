...
const FoodDetails: React.FC = () => {
  ...
  useEffect(() => {
    async function loadFood(): Promise<void> {
      ...
      setFood(data);
      const extrasAux = data.extras.map(extra => ({
        ...extra,
        quantity: 0,
      }));
      ...
      const favoriteData = await api.get(`/favorites/${id}`);
      setIsFavorite(favoriteData.data);
    }
  ...
  function handleIncrementExtra(id: number): void {
    const extrasFiltered = extras.map(extra => ({
      ...extra,
